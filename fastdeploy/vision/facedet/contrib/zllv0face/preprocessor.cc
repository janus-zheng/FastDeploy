...
Zllv0FacePreprocessor::Zllv0FacePreprocessor() {
  size_ = {640, 640};
...
bool Zllv0FacePreprocessor::Run(
...
bool Zllv0FacePreprocessor::Preprocess(
...
void Zllv0FacePreprocessor::LetterBox(FDMat* mat) {
  float scale =
